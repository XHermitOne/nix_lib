...
test: test.o version.o logfunc.o strfunc.o toolfunc.o filefunc.o 
	$(CC) -o test ./obj/test.o ./obj/version.o ./obj/logfunc.o ./obj/strfunc.o ./obj/toolfunc.o ./obj/filefunc.o $(LDFLAGS)
